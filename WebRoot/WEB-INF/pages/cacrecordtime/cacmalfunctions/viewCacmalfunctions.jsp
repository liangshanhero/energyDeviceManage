...
<body>
	<div id="contentarea">
								...
								<form action="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${cacmalfunctionPageNumber+1}页         每页显示${cacmalfunctionPageSize}条      总共${cacmalfunctionTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectCacrecordtimeCacmalfunctions?cacrecordtime_id=${cacrecordtime.id}&page=jumpPage" method="post">
