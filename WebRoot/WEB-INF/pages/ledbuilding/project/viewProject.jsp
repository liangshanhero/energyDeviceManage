...
<body>
	<div id="contentarea">
								...
								<form action="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${projectPageNumber+1}页         每页显示${projectPageSize}条      总共${projectTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectLedbuildingProjects?ledbuilding_id=${ledbuilding.id}&page=jumpPage" method="post">
