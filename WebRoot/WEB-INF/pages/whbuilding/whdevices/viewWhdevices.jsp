...
<body>
	<div id="contentarea">
										<div id="content">
											...
											<div class="navitem">
												<a class="button"
													href="${pageContext.request.contextPath}/indexWhbuilding?page=homePage"><span><img
														src="images/icons/back.gif" />
													<fmt:message key="navigation.back" /></span></a>
											</div>

								<form action="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${whdevicePageNumber+1}页         每页显示${whdevicePageSize}条      总共${whdeviceTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectWhbuildingWhdevices?whbuilding_id=${whbuilding.id}&page=jumpPage" method="post">
