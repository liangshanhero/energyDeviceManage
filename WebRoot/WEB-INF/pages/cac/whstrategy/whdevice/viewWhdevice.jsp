...
<body>
	<div id="contentarea">
								...
								<form action="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${whdevicePageNumber+1}页         每页显示${whdevicePageSize}条      总共${whdeviceTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectWhstrategyWhdevices?whstrategy_id=${whstrategy.id}&page=jumpPage" method="post">
