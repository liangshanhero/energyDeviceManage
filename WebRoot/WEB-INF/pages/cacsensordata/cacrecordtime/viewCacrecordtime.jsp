...
<body>
	<div id="contentarea">
								...
								<form action="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${cacrecordtimePageNumber+1}页         每页显示${cacrecordtimePageSize}条      总共${cacrecordtimeTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectCacsensordataCacrecordtimes?cacsensordata_cacrecordtime=${cacsensordata.cacrecordtime}&cacsensordata_cacsensor=${cacsensordata.cacsensor}&page=jumpPage" method="post">
