	...
	<div id="contentarea">
										<div id="content">
											<h1>
												...
												<fmt:message key="whdevicedata.title" />
											</h1>
											<div class="navitem">
												<a class="button"
													href="${pageContext.request.contextPath}/indexWhdevice?page=homePage"><span><img
														src="images/icons/back.gif" />
													<fmt:message key="navigation.back" /></span></a>
											</div>

								<form action="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<%}%>
			   							 ...
			   							 <c:if test="${whdevicedataPageNumber+4>whdevicedataTotalPage }">
										...
										<td><a  href="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${whdevicedataPageNumber+1}页         每页显示${whdevicedataPageSize}条      总共${whdevicedataTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectWhdeviceWhdevicedatas?whdevice_id=${whdevice.id}&page=jumpPage" method="post">
