	...
	<div id="contentarea">
										<div id="content">
											<h1>
												...
												<fmt:message key="ledmeterdata.title" />
											</h1>
											<div class="navitem">
												<a class="button"
								...
								<form action="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<%}%>
			   							 ...
			   							 <c:if test="${ledmeterdataPageNumber+4>ledmeterdataTotalPage }">
										...
										<td><a  href="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${ledmeterdataPageNumber+1}页         每页显示${ledmeterdataPageSize}条      总共${ledmeterdataTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectLedmeterLedmeterdatas?ledmeter_id=${ledmeter.id}&page=jumpPage" method="post">
