	...
	<div id="contentarea">
										<div id="content">
											<h1>
												...
												<fmt:message key="cacdevicedata.title" />
											</h1>
											<div class="navitem">
												<a class="button"
								...
								<form action="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<%}%>
			   							 ...
			   							 <c:if test="${cacdevicedataPageNumber+4>cacdevicedataTotalPage }">
										...
										<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${cacdevicedataPageNumber+1}页         每页显示${cacdevicedataPageSize}条      总共${cacdevicedataTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectCacrecordtimeCacdevicedatas?cacrecordtime_id=${cacrecordtime.id}&page=jumpPage" method="post">
