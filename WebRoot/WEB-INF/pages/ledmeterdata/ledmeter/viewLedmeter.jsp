...
<body>
	<div id="contentarea">
										<div id="content">
											...
											<div class="navitem">
												<a class="button"
													href="${pageContext.request.contextPath}/indexLedmeterdata?page=homePage"><span><img
														src="images/icons/back.gif" />
													<fmt:message key="navigation.back" /></span></a>
											</div>

								<form action="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${ledmeterPageNumber+1}页         每页显示${ledmeterPageSize}条      总共${ledmeterTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectLedmeterdataLedmeters?ledmeterdata_id=${ledmeterdata.id}&page=jumpPage" method="post">
