...
<%-- <LINK 
href="${pageContext.request.contextPath}/css/user_LoginCss.css" type=text/css rel=stylesheet>
...
.navbar-inverse .navbar-nav>.active>a {
	...
	background-image: -webkit-gradient(linear, left top, left bottom, from(#222),
		to(#282828));
...
.templatemo-input-icon-container input,.templatemo-input-icon-container textarea
	{
	padding-left: 30px;
}
...
.templatemo-contact-form-1 .form-control:focus {
	box-shadow: inset 0 1px 1px rgba(140, 220, 60, 0.7), 0 0 10px
		rgba(140, 220, 60, 0.7);
}
...
<script language="javascript">
	function check() {
		...
		if ((username.trim()== "") || (username == null)) { //判断用户名是否为空
			alert("请输入用户名！");
			return false;

		} else if ((password.trim()== "") || (password == null)) { //判断密码是否为空
			alert("请输入密码！");
			return false;
		} else {
			return true;
