...
<html>
<head>
<title>Delete<fmt:message key="whdatatype.title"/></title>
</head>
<body>
	<div id="content">
		...
		<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteWhdatatype?id=${whdatatype.id}"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
		<div class="clear">&nbsp;</div>
	</div>
</body>
</html>
