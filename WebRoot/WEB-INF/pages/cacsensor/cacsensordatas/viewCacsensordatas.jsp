...
<body>
	<div id="contentarea">
										<div id="content">
											...
											<div class="navitem">
												<a class="button"
													href="${pageContext.request.contextPath}/indexCacsensor?page=homePage"><span><img
														src="images/icons/back.gif" />
													<fmt:message key="navigation.back" /></span></a>
											</div>

								<form action="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=eachPageShow" method="post">
								...
								<table cellpadding="0" cellspacing="0" id="viewTable">
										...
										<tr>
											<td><a  href="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=homePage">首页</a></td>
											<td><a  href="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=previousPage">上一页</a></td>
											...
											<td><a  href="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=jumpPage&WantToPage=<%=i%>"><%=i%></a></td>
											<%}%>
										</c:if>
										...
										<td><a  href="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=nextPage">下一页</a></td>
										<td><a  href="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=lastPage">尾页</a> 	</td>
								</tr><br>
									当前为第${cacsensordataPageNumber+1}页         每页显示${cacsensordataPageSize}条      总共${cacsensordataTotalPage+1}页<br>
									<form action="${pageContext.request.contextPath}/selectCacsensorCacsensordatas?cacsensor_id=${cacsensor.id}&page=jumpPage" method="post">
